# 🌐 AWS VPC — Complete Deep Dive + Advanced Labs
> **Domain:** Networking | **Level:** Beginner → Expert  
> **Estimated Time:** Foundation Labs: 4–6 hrs | Advanced Labs: 8–12 hrs  
> **AWS Services:** VPC, Subnets, IGW, NAT Gateway, Security Groups, NACLs, VPC Peering, VPC Endpoints, Transit Gateway, ALB, Route 53, Network Firewall, GuardDuty, Flow Logs, Terraform  
> **Region:** ap-south-1 (Mumbai) | **Estimated Cost:** < $3 USD for all labs
...
| Network Firewall | $0.395/hr per AZ |
| **Foundation Labs (4 hours)** | **~$0.25** |
| **All Labs including advanced (12 hours)** | **~$2.50** |
...
*Version: 3.0 — Foundation + Advanced + Expert Labs (30 Labs Total) | Estimated Cost: < $5 for all labs*  
*Services: VPC, Subnets, IGW, NAT, Endpoints, TGW, ALB, Route 53, Network Firewall, GuardDuty, Client VPN, PrivateLink, Traffic Mirroring, VPC Lattice, IPAM, Network Monitor, Terraform*
